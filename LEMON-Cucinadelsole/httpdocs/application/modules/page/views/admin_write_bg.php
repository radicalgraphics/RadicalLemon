<div class="new-page-container">
	<div class="sub-container">
		<div class="title">
			<span class="bold">Add text!</span><span>Add text to your background</span>
		</div>
 
		<div class="top-line"></div>
		<div class="form-content">
			<form id="text-form" method="post">
				<input id="id_page_data" type="hidden" name="id_page_data" value="<?php if(!empty($write_slide->id_page_data)) { echo $write_slide->id_page_data; } else { echo $id_page_data; }?>"/>
                <textarea name="content"><?php if (!empty($write_slide->content)) { echo $write_slide->content; }?></textarea>
				<div class="clear"></div>
...
tinymce.init({
	...
	fontsize_formats: "8px 10px 12px 14px 15px 16px 60px",
	textcolor_map: [
        "FFFFFF", "White",
        "000101", "Black",
        "B72025", "Red",
	...
	style_formats: [
        ...
        {title : 'Title 1', block : 'h1', styles : {color : '#B72025', fontSize: '60px', fontFamily: 'Georgia1,Georgia,serif', fontWeight: 'normal', lineHeight: '140%'}},
        {title : 'Title 2', block : 'h2', styles : {color : '#000102', fontSize: '24px', fontFamily: 'Georgia1,Georgia,serif', fontWeight: 'normal', lineHeight: '160%'}},
        {title : 'Text', block : 'p', styles : {color : '#000102', fontSize: '15px', fontFamily: 'Georgia1,Georgia,serif', fontWeight: 'normal', lineHeight: '160%' }}
	...
	$("#text-form").validate({
			...
			submitHandler: function(form) {
                $(form).ajaxSubmit({
                        ...
                        type:"post",
						data: { "template": "page", "method" : "saveBgText"},
