                    ...
                    <li id="<?php echo $active->id; ?>" class="ui-state-default">
                        <div class="image-area">
                            ...
                            <div class="slide-img">
                                ...
                                <img src="<?php echo base_url()."media/slider/".$active->img; ?>" width="170" />
                            </div>
                ...
                <?php foreach ($non_active_bgslide as $nonactive) : ?>
                    <li id="<?php echo $nonactive->id; ?>" class="ui-state-default">
                        <div class="image-area">
                             ...
                             <div class="slide-img">
                                <img src="<?php echo base_url()."media/slider/".$nonactive->img; ?>"  width="170"/>
                               </div>
                ...
                receive: function(event, ui) {
                    ...
                    if (area == "sortable2") {
                        $.ajax({
                            ...
                            type: 'POST',
                            data: {"template": "slider", "method": "setNonActiveSlide", "id_page_data": <?php echo $id; ?>, "video_id": video_id},
                    ...
                    if ($("#sortable1 li").length <= 16) {
                        ...
                        if (area == "sortable1") {
                            $.ajax({
                                url: "<?php echo site_url('admin/moduleFunctions'); ?>",
                                type: 'POST',
                                data: {"template": "slider", "method": "setActiveSlide", "id_page_data": <?php echo $id; ?>, "video_id": video_id},
                                success: function(data) {
                                    $('#imgstatus').html(data);
                                }
                            });
                        ...
                        $("#overlay").fadeIn().show().html('<div class="message"><div class="message-container"><div class="title">Message!</div><div class="top-line"></div><div class="message-icon"><img src="<?php echo base_url() . "skin/admin/images/ls-navigation.png" ?>"/></div><div class="message-text">You can publish maximum 16 slides!</div><div class="close"><button class="close-button" type="button" onclick="window.location.reload()"></button></div><div class="bottom-line"></div></div></div>');
                ...
                update: function(event, ui) {
                    ...
                    if (area == "sortable2") {
                        $.ajax({
                            url: "<?php echo site_url('admin/moduleFunctions'); ?>",
                            type: 'POST',
                            data: {"template": "slider", "method": "slideOrderNonActive", "id_page_data": <?php echo $id; ?>, "orderId": info},
                            success: function(data) {
                                $('#imgstatus').html(data);
                            }
                        });
                    ...
                    if (area == "sortable1") {
                        $.ajax({
                            url: "<?php echo site_url('admin/moduleFunctions'); ?>",
                            type: 'POST',
                            data: {"template": "slider", "method": "slideOrderActive", "id_page_data": <?php echo $id; ?>, "orderId": info},
                            success: function(data) {
                                $('#imgstatus').html(data);
                            }
                        });
                ...
                function() {
                    ...
                    $('#w' + slide_id).click(function() {
                        ...
                        $.ajax({
                            url: "<?php echo site_url('admin/moduleFunctions'); ?>",
                            type: 'post',
                            data: {"template": "slider", "method": "writeSlide", "slide_id": slide_id},
                            success: function(data) {
                    ...
                    $('#t' + slide_id).click(function() {
                        ...
                        $.ajax({
                            url: "<?php echo site_url('admin/moduleFunctions'); ?>",
                            type: 'post',
                            data: {"template": "slider", "method": "addTitle", "slide_id": slide_id},
                            success: function(data) {
                    ...
                    $('#u' + slide_id).click(function() {
                        ...
                        $.ajax({
                            url: "<?php echo site_url('admin/moduleFunctions'); ?>",
                            type: 'post',
                            data: {"template": "slider", "method": "uploadPdf", "slide_id": slide_id},
                            success: function(data) {
                   ...
                   $('#e'+slide_id).click(function(){
                       ...
                       $("#overlay").show();
									...
									$.ajax({
                                            url: "<?php echo site_url('admin/moduleFunctions');?>",
											type: 'post',
											data: { "template": "slider", "method" : "addDate", "slide_id": slide_id  },
											success: function(data) {
                    ...
                    $('#p' + slide_id).click(function() {
                        ...
                        $.ajax({
                            url: "<?php echo site_url('admin/moduleFunctions'); ?>",
                            type: 'post',
                            data: {"template": "slider", "method": "previewSlide", "video_id": slide_id},
                            success: function(data) {
                    ...
                    $('#d' + slide_id).click(function() {
                        ...
                        $("#del_yes").click(function() {
                            ...
                            $.ajax({
                                url: "<?php echo site_url('admin/moduleFunctions'); ?>",
                                type: 'post',
                                data: {"template": "slider", "method": "deleteSlide", "video_id": slide_id},
                                success: function(data) {
