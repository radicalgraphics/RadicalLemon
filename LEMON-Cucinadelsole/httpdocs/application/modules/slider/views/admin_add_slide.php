	...
	$('.radio-buttons-add div div').click(function() {
                ...
                e.preventDefault();
                    ...
                    $.ajaxFileUpload({
                       ...
                       success  : function (data)
                       {
                         ...
                         $('#image-place').html('<img id="crop" src="<?php echo base_url('media/slider/original_images');?>/'+data.img+'"alt="eeee"/>');
                         ...
                         function showCoords(c)
                        {
                            ...
                            var img = data.img;
                                    $.ajax({
                                                type: "post",
                                                url: "<?php echo site_url('admin/moduleFunctions'); ?>",
                                                data: { "template": "slider", "method" : "cropImg", "x": x , "y": y , "w" : w , "h" : h, "img" : img },
                                                cache:false,
                                                success: function(data) {            
		...
		submitHandler: function(form) {
            ...
            $(form).ajaxSubmit({
                        ...
                        type:"post",
						data: { "template":"slider", "method":"saveSlide", "lang":lang },
						success: function(data){
							if ( data == 'true') {
								$("#overlay").show();
