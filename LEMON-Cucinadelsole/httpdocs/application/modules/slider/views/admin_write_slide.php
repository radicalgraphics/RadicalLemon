...
tinymce.init({
	...
	style_formats: [
        ...
        {title : 'Title 1', block : 'h1', styles : {color : '#B72025', fontSize: '30px', fontFamily: 'Georgia1,Georgia,serif', fontWeight: 'bold' , lineHeight: '160%'}},
        {title : 'Text', block : 'p', styles : { fontSize: '14px', color:'#000000', fontFamily: 'Georgia1,Georgia,serif', fontWeight: 'normal', lineHeight: '140%' }}
	],
	...
	$("#text-form").validate({
			...
			submitHandler: function(form) {
                $(form).ajaxSubmit({
                        ...
                        type:"post",
						data: { "template": "slider", "method" : "saveText"},
